...
/**
 * Validates the incoming request body against the POST /analyze-ticket schema.
 * Checks required fields, types, enum values, and transaction history structure.
 * @param {Object} body - The parsed JSON request body.
 * @returns {{valid: boolean, status?: number, error?: string}} Validation result with HTTP status on failure.
 */
...
/**
 * Validates a single transaction history entry against the schema in Section 5.2.
 * @param {Object} tx - The transaction object to validate.
 * @param {number} index - The index of this transaction in the array (for error messages).
 * @returns {{valid: false, status: number, error: string} | null} Error object if invalid, null if valid.
 */
...
/**
 * Validates the response object against the POST /analyze-ticket response schema (Section 6).
 * Checks all required fields, types, and enum values.
 * @param {Object} resp - The response object to validate.
